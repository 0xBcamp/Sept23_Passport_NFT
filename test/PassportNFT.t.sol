...
contract PassportNftTest is Test {
    ...
    function testGrantStamp() external createPassport {
        vm.prank(user);
        bytes32 attestationUID = passportNft.grantStamp("John Doe", "India");
    ...
    function testCannotGrantStampWithoutPassport() external {
        ...
        passportNft.grantStamp("John Doe", "Australia");
    }
    ...
    function testGetStamps() external createPassport {
        vm.startPrank(user);
        bytes32 stamp1 = passportNft.grantStamp("John Doe", "India");
        bytes32 stamp2 = passportNft.grantStamp("John Doe", "Australia");
        vm.stopPrank();
